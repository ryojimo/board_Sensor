...
Help(
    ...
    AppIfPc_Printf( " Ex)                         \n\r" );
    AppIfPc_Printf( "     -a               -h     \n\r" );
    AppIfPc_Printf( "     --si_bmx055_acc  --help \n\r" );
    AppIfPc_Printf( "     -a               -j     \n\r" );
    AppIfPc_Printf( "     --si_bmx055_acc  --json \n\r" );
    AppIfPc_Printf( "     -a               -x     \n\r" );
    AppIfPc_Printf( "     --si_bmx055_acc  --x    \n\r" );
...
GetData(
    ...
    // センサデータを取得
    data = HalSensorBMX055Acc_Get( which );
...
GetJson(
    ...
    // センサデータを取得
    dataX = HalSensorBMX055Acc_Get( EN_SEN_BMX055_X );
    dataY = HalSensorBMX055Acc_Get( EN_SEN_BMX055_Y );
    dataZ = HalSensorBMX055Acc_Get( EN_SEN_BMX055_Z );
    ...
    // PC ターミナル表示
    AppIfPc_Printf( "{\"sensor\": \"si_bmx055_acc\", \"value\": {\"x\": %+5.2f, \"y\": %+5.2f, \"z\": %+5.2f}} \r",
                    dataX->cur,
                    dataY->cur,
                    dataZ->cur );
    AppIfPc_Printf( "\n\r" );
...
OptCmd_SiBmx055AccMenu(
    ...
    DBG_PRINT_TRACE( "OptCmd_SiBmx055AccMenu() \n\r" );
...
OptCmd_SiBmx055Acc(
    ...
    DBG_PRINT_TRACE( "OptCmd_SiBmx055Acc() \n\r" );
    AppIfLcd_CursorSet( 0, 1 );
    ...
    while( 1 )
    {
        ...
        case 'm': OptCmd_SiBmx055AccMenu(); break;
