/**************************************************************************//*!
 *  @file           hal_drv_sensor_i2c_bmx055_gyro.c
 *  @brief          [HAL] SENSOR (I2C) BMX055 ドライバ (ジャイロ) API を定義したファイル。
 *  @author         Ryoji Morita
 *  @attention      none.
 *  @sa             none.
 *  @bug            none.
...
HalSensorBMX055Gyro_Init(
    ...
    // I2C スレーブデバイスを BMX055_GYRO に変える
